module github.com/altshiftab/x

go 1.25.1

require (
	github.com/Motmedel/utils_go v0.0.258
	github.com/Motmedel/utils_go/pkg/http/mux v0.0.98
	github.com/Motmedel/utils_go/pkg/http/mux/utils/body_parser/json/schema v0.0.14
...
require (
	github.com/Motmedel/dns_utils v0.0.47 // indirect
	github.com/Motmedel/dns_utils/pkg/log v0.0.10 // indirect
	github.com/Motmedel/ecs_go v0.0.65 // indirect
	...
	github.com/altshiftab/mux_static_content/cmd/generate_endpoints v0.0.4 // indirect
